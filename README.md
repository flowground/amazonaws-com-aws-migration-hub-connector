# ![LOGO](logo.png) AWS Migration Hub MSP Connector

## Description

A generated MSP connector for the AWS Migration Hub API (version 2017-05-31).
...
flowground :- Telekom iPaaS / amazonaws-com-aws-migration-hub-connector<br/>
